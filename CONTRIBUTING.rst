...
Welcome to ``akula`` contributor's guide.
...
If you experience bugs or general issues with ``akula``, please have a look
...
You can help improve ``akula`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``akula`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``akula``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n akula python=3 six virtualenv pytest pytest-cov
    conda activate akula
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/akula.git
    cd akula
...
#. Install |pre-commit|_::
   ...
   ``akula`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/akula
.. _issue tracker: https://github.com/<USERNAME>/akula/issues
.. <-- end -->
