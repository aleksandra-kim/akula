...
if __name__ == "__main__":
    ...
    #     print(random_seed)
    #     for bg_name in [tname, bname, cname]:
    #         print(bg_name)
    #         indices = datapackages[bg_name]["indices_wo_lowinf"]
    #         dp = create_background_datapackage(
    #             bg_name, f"{bg_name}-{random_seed}", indices, num_samples=xiterations, seed=random_seed,
    #         )
    ...
    for random_seed in random_seeds:
        ...
        fp_xgboost = write_dir / f"mc.xgboost.{xiterations}.{random_seed}.pickle"
